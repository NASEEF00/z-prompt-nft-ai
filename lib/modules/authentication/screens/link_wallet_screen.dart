...
import 'package:z_prompt/modules/authentication/widgets/social_auth_button.dart';
import 'package:z_prompt/utils/constants.dart';
import 'package:z_prompt/utils/fonts.dart';
...
import 'package:z_prompt/widgets/primary_button.dart';
import 'package:z_prompt/widgets/custom_outlined_button.dart';
import 'package:z_prompt/modules/dashboard/screens/dashobard_screen.dart';
import 'package:z_prompt/utils/session_helper.dart';
...
class _LinkWalletScreenState extends State<LinkWalletScreen> {
  ...
  Future<void> initPlatformState() async {
    ...
    if (Platform.isAndroid) {
      redirectUrl = Uri.parse('https://com.example.z_prompt/auth');
    ...
    await Web3AuthFlutter.init(
      Web3AuthOptions(
        ...
        whiteLabel:
            WhiteLabelData(dark: true, name: "z_prompt", theme: themeMap),
      ),
    );
  }
